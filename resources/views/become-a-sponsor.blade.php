...
<section class="sponsors_section" id="sponsors_section">
    <div class="sponsor_wrapper">
        <div class="sponsor_header">
            <p class="sponsor_heading">Current Sponsors</p>
        </div>
        <div class="sponsors_img_wrapper">
            <div class="first_set">
                <img src="{{ asset("images/Sponsorpage/IBM logo.png");}}" alt="">
                <img src="{{ asset("images/Sponsorpage/google logo.png");}}" alt="">
                <img src="{{ asset("images/Sponsorpage/netflix logo.png");}}" alt="">
            </div>
            <div class="second_set">
                <img src="{{ asset("images/Sponsorpage/Nestle logo.png");}}" alt="">
                <img src="{{ asset("images/Sponsorpage/HSBC logo.png");}}" alt="">
                <img src="{{ asset("images/Sponsorpage/linkedin logo.png");}}" alt="">
            </div>
            <img src="{{ asset("images/Sponsorpage/Facebook logo.png");}}" alt="">
        </div>
    </div>
</section>
