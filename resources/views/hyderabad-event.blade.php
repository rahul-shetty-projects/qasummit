    ...
    <div class="hero_section_wrapper">
        ...
        <div class="hero_first_div">
            <div class="border_style">
                <p class="hero_headline" style="margin-bottom: 0!important;">QASummit <span class="hero_headline_span">Hyderabad</span></p>
            </div>
            <p class="hero_heading">Calling All QA Enthusiasts from "City of Pearls" in India</p>
            <p class="event_location"><img src="{{ asset("images/Homepage/Location.png") }}" alt=""><span>Hyderabad, Telangana</span></p>
...
<section class="schedule_section" id="schedule_section">
    <div class="schedule_wrapper">
        <div class="schedule_heading_div">
            ...
            <p class="schedule_summary"><b><span class="grad_text">When :</span> Aug 24th 2024, 10:30AM </b></p>
            <p class="schedule_summary"><b><span class="grad_text">Where :</span> Hyderabad, India </b></p>
            <p class="schedule_summary"><b><span class="grad_text">Event Address :</span> T-HUb </b></p>
        </div>
        <div class="timeline_div">
            <div class="schedule_days">
                <div class="day_1">
                    <!-- <p class="schedule_day">Day 01</p> -->
                    <p class="schedule_date">August 24<span class="span_date">ᵗʰ, 2025</span></p>
                </div>
                <!-- <div class="day_2">
                    <p class="schedule_day">Day 01</p>
            ...
            <div class="timeline_wrapper">
                <div class="timeline_1">
                    <div class="event_time">
                        <p class="eve_time">10:30 AM - 11:15 AM</p>
                    </div>
                    <div class="schedule_titles">
                        <p class="sch_title">1st Subject</p>
                        <p class="sch_summary">Career Guidance Session with Rahul Shetty.</p>
                    </div>
                </div>
                <div class="timeline_2">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">Trending QA Technologies to Learn by 2025.</p>
                    </div>
                </div>
                <div class="timeline_3">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">How AI Can Change the QA Interview Process?</p>
                    </div>
                </div>
                <div class="timeline_4">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">Will AI Cut QA Jobs? Emerging AI-Powered QA Tool</p>
                    </div>
                </div>
                <div class="timeline_5">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">Future of AI in QA Automation.</p>
                    </div>
                </div>
                <div class="timeline_6">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">Expand Your Network by connecting with fellow QA's</p>
                    </div>
                </div>
...
<!-- <section class="event_booking" id="event_booking">
    <div class="event_booking_wrapper">
        <div class="headline_content">
            ...
            <p class="early_bird_summary">Secure your spot today and take advantage of our early bird pricing until July 30, 2024.</p>
        </div>
...
<section class="speaker_form_section" id="speaker_form_section">
    <div class="form_wrapper">
        ...
        <div class="headline_content">
            ...
            <p class="early_bird_summary">Subscribe now for updates on upcoming Hyderabad events.</p>
        </div>
        <div class="form_wrap">
            <form id="contactForm">
                ...
                <div class="email_div">
                    ...
                    <input required type="text" name="" id="speakercity" class="speakermail_inp" placeholder="Hyderabad">
                </div>
                ...
                <div class="accordion accordion-flush" id="accordionFlushExample">
                    ...
                    <div class="accordion-item">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                            <div class="accordion-body">Connect with fellow QA professionals, industry experts, and leaders in Hyderabad’s vibrant tech community.
                            </div>
                        </div>
                    </div>
                    <div class="accordion-item">
