...
<section class="hero_section" id="hero_section">
    <div class="hero_section_wrapper">
        ...
        <div class="hero_first_div">
            ...
            <p class="hero_heading">Calling all QA enthusiasts from the Heart of the UK!</p>
...
<section class="schedule_section" id="schedule_section">
    <div class="schedule_wrapper">
        <div class="schedule_heading_div">
            ...
            <p class="schedule_summary"><b><span class="grad_text">When :</span> October 11th 2025, 10AM </b></p>
            <p class="schedule_summary"><b><span class="grad_text">Where :</span> London, UK </b></p>
            <p class="schedule_summary"><b><span class="grad_text">Event Address :</span> University of West London - Ealing, London </b></p>
        </div>
        <div class="timeline_div">
            <div class="schedule_days">
                <div class="day_1">
                    <!-- <p class="schedule_day">Day 01</p> -->
                    <p class="schedule_date">October 11<span class="span_date">ᵗʰ, 2025</span></p>
                </div>
                <!-- <div class="day_2">
                    <p class="schedule_day">Day 01</p>
            ...
            <div class="timeline_wrapper">
                <div class="timeline_1">
                    <div class="event_time">
                        <p class="eve_time">10:00 AM - 10:15 AM</p>
                    </div>
                    <div class="schedule_titles">
                        <p class="sch_title">Event Begins</p>
                        <p class="sch_summary">Meet & Greet/Networking with Local UK - QA Engineers</p>
                    </div>
                </div>
                <div class="timeline_2">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">30 Minutes Workshop on AI Fundamentals - Understand Gen AI, AI Agents, MCP Servers, Agentic AI
                        </p>
                    </div>
                </div>
                <div class="timeline_3">
                    <div class="event_time">
                        <p class="eve_time">10:45 AM - 11:00 AM</p>
                    </div>
                    <div class="schedule_titles">
                        <p class="sch_title">2nd Subject</p>
                        <p class="sch_summary">The Era of LLM Testing - Are automated tests for ML models the next big revolution?
                        </p>
                    </div>
                </div>
                <div class="timeline_4">
                    <div class="event_time">
                        <p class="eve_time">11:00 AM - 11:30 AM</p>
                    </div>
                    <div class="schedule_titles">
                        <p class="sch_title">3rd Subject</p>
                        <p class="sch_summary">Exploring 2025-26 QA Automation Trends & Technologies - UK Job Market evaluation and insights.
                        </p>
                    </div>
                </div>
                <div class="timeline_5">
                    <div class="event_time">
                        <p class="eve_time">11:30 AM - 11:45 AM</p>
                    </div>
                    <div class="schedule_titles">
                ...
                <div class="timeline_6">
                    <div class="event_time">
                        <p class="eve_time">11:45 AM - 12:00 PM</p>
                    </div>
                    <div class="schedule_titles">
                        <p class="sch_title">4th Subject</p>
                        <p class="sch_summary">Impact of AI at workplace - How to stay relevant & Be more productive with AI as your coworker.
                        </p>
                    </div>
                </div>
                <div class="timeline_7">
                    ...
                    <div class="schedule_titles">
                        ...
                        <p class="sch_summary">QA Career Guidance and Learning Roadmap - Stay ahead in the ever-evolving tech landscape.
                        </p>
                    </div>
                </div>
...
<section class="event_booking" id="event_booking">
    <div class="event_booking_wrapper">
        <div class="headline_content">
            ...
            <p class="early_bird_summary">Secure your spot today and take advantage of our early bird pricing until Sept 15, 2025.</p>
        </div>
        <div class="days_remaining">
            <p class="remaining_days">20 Days Remaining!</p>
        </div>
